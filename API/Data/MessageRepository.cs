...
namespace API.Data
{
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentUserName, string recipientUserNamed)
        {
            var messages = await _context.Messages
                    ...
                    .Where(
                        ...
                        m.SenderUsername == recipientUserNamed ||
                        m.RecipientUsername == recipientUserNamed && m.SenderDeleted == false &&
